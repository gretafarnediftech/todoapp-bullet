...
// Compute proper Unix ms timestamps for entries whose completedAt was previously
// stored as a small integer offset (minutes-ago, like the `ago` field).
const _NOW = Date.now()
const _minsAgo = (m: number) => _NOW - m * 60_000
...
export const SEED_ENTRIES: Entry[] = [
  ...
  { id: 'd3',  view: 'daily',   type: 'task',  text: 'Pick up dry cleaning on Bryanston',            ago: 145,  status: 'done',   completedAt: _minsAgo(12) },
  ...
  { id: 'd8',  view: 'daily',   type: 'task',  text: 'Stretch — 10 min, real ones',                  ago: 340,  status: 'done',   completedAt: _minsAgo(280), when: '07:30' },
  ...
  { id: 'w6',  view: 'weekly',  type: 'task',  text: 'Book haircut',                                 ago: 3600, status: 'done',   completedAt: _minsAgo(2500) },
  ...
  { id: 'b4',  view: 'backlog', type: 'task',  text: 'Re-read "How To Take Smart Notes"',            ago: 26000, status: 'done',  completedAt: _minsAgo(18000) },
  ...
  { id: 'b11', view: 'backlog', type: 'task',  text: 'Get the bike serviced before spring',          ago: 38000, status: 'done',  completedAt: _minsAgo(24000) },
